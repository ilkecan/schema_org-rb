  ...
  module Mixins
    module Place
      ...
      included do
        ...
        option :contained_in # The basic containment relation between a place and one that contains it. Superseded by `contained_in_place`.
        ...
        option :map # A URL to a map of the place. Superseded by `has_map`.
        option :maps # A URL to a map of the place. Superseded by `has_map`.
        ...
        option :photos # Photographs of this place. Superseded by `photo`.
