...
module SchemaOrg
  module Mixins
    module Article
      ...
      included do
        option :article_body # The actual body of the article.
        option :article_section # Articles may belong to one or more 'sections' in a magazine or newspaper, such as Sports, Lifestyle, etc.
