...
module SchemaOrg
  module Mixins
    module ExerciseAction
      ...
      included do
        option :course # A sub property of location. The course where this action was taken. Superseded by `exercise_course`.
        ...
        option :exercise_course # A sub property of location. The course where this action was taken. Supersedes `course`.
      end
    end
  end
end
