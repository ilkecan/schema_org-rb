  ...
  module Mixins
    module FoodEstablishment
      ...
      included do
        ...
        option :menu # Either the actual menu as a structured representation, as text, or a URL of the menu.
        ...
        option :has_menu # Either the actual menu as a structured representation, as text, or a URL of the menu.
      end
    end
  end
end
