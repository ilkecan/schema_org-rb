  ...
  module Mixins
    module JobPosting
      ...
      included do
        ...
        option :benefits # Description of benefits associated with the job.
        ...
        option :incentives # Description of bonus and commission compensation aspects of the job.
        ...
        option :incentive_compensation # Description of bonus and commission compensation aspects of the job.
        option :job_benefits # Description of benefits associated with the job.
      end
    end
  end
end
