  ...
  module Mixins
    module PriceSpecification
      ...
      included do
        ...
        option :max_price # The highest price if the price is a range.
        option :min_price # The lowest price if the price is a range.
        ...
        option :value_added_tax_included # Specifies whether the applicable value-added tax (VAT) is included in the price specification or not.
      end
    end
  end
end
