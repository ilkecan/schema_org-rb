  ...
  module Mixins
    module CreativeWork
      ...
      included do
        ...
        option :encodings # A media object that encodes this CreativeWork.
        ...
        option :is_based_on_url # A resource that was used in the creation of this resource. This term can be repeated for multiple sources. For example, http://example.com/great-multiplication-intro.html.
        ...
        option :example_of_work # A creative work that this work is an example/instance/realization/derivation of.
        ...
        option :interaction_statistic # The number of interactions for the CreativeWork using the WebSite or SoftwareApplication. The most specific child type of InteractionCounter should be used.
        option :is_accessible_for_free # A flag to signal that the item, event, or place is accessible for free.
        option :is_based_on # A resource from which this work is derived or from which it is a modification or adaptation.
        option :main_entity # Indicates the primary entity described in some page or other CreativeWork.
        ...
        option :recorded_at # The Event where the CreativeWork was recorded. The CreativeWork may capture all or part of the event.
        ...
        option :work_example # Example/instance/realization/derivation of the concept of this creative work. E.g. the paperback edition, first edition, or e-book.
        option :about # The subject matter of the content.
        option :encoding # A media object that encodes this CreativeWork. This property is a synonym for associatedMedia.
        option :material # A material that something is made from, e.g. leather, wool, cotton, paper.
        option :has_part # Indicates an item or CreativeWork that is part of this item, or CreativeWork (in some sense).
        option :is_part_of # Indicates an item or CreativeWork that this item, or CreativeWork (in some sense), is part of.
