...
module SchemaOrg
  module Mixins
    module Reservation
      ...
      included do
        option :booking_agent, optional: true # 'bookingAgent' is an out-dated term indicating a 'broker' that serves as a booking agent. Superseded by `broker`.
        option :booking_time, optional: true # The date and time the reservation was booked.
        option :modified_time, optional: true # The date and time the reservation was modified.
        ...
        option :program_membership_used, optional: true # Any membership in a frequent flyer, hotel loyalty program, etc. being applied to the reservation.
        option :reservation_for, optional: true # The thing -- flight, event, restaurant, etc. being reserved.
        option :reservation_id, optional: true # A unique identifier for the reservation.
        option :reservation_status, optional: true # The current status of the reservation.
        option :reserved_ticket, optional: true # A ticket associated with the reservation.
