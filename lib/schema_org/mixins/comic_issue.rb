...
module SchemaOrg
  module Mixins
    module ComicIssue
      ...
      def self.schema_property_definitions
        {
          ...
          variant_cover: {
            schema_name: "variantCover",
            schema_url: "https://schema.org/variantCover",
            comment_lines: ["A description of the variant cover", "    \tfor the issue, if the issue is a variant printing. For example, \"Bryan Hitch", "    \tVariant Cover\" or \"2nd Printing Variant\"."].freeze,
            ranges: ["Text"].freeze,
            external_ranges: [].freeze,
            inverse_of: nil,
            superseded_by: nil,
      ...
      def variant_cover
        read_property(:variant_cover)
      end

      # A description of the variant cover
      #     	for the issue, if the issue is a variant printing. For example, "Bryan Hitch
      #     	Variant Cover" or "2nd Printing Variant".
      def variant_cover=(value)
        write_property(:variant_cover, value)
      end
    end
  end
end
