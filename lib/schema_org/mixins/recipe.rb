  ...
  module Mixins
    module Recipe
      ...
      included do
        ...
        option :ingredients # A single ingredient used in the recipe, e.g. sugar, flour or garlic. Superseded by `recipe_ingredient`.
        ...
        option :recipe_ingredient # An ingredient or ordered list of ingredients and potentially quantities used in the recipe, e.g. 1 cup of sugar, flour or garlic.  The ingredients can be represented as free text or more structured values. Supersedes `ingredients`.
      end
    end
  end
end
