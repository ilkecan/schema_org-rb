  ...
  module Mixins
    module Event
      ...
      included do
        ...
        option :attendees # A person attending the event. Superseded by `attendee`.
        ...
        option :performers # The main performer or performers of the event&#x2014;for example, a presenter, musician, or actor. Superseded by `performer`.
        ...
        option :sub_events # Events that are a part of this event. For example, a conference event includes many presentations, each subEvents of the conference. Superseded by `sub_event`.
        ...
        option :attendee # A person or organization attending the event. Supersedes `attendees`.
