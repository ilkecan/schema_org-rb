  ...
  module Mixins
    module Event
      ...
      included do
        ...
        option :attendees, optional: true # A person attending the event. Superseded by `attendee`.
        ...
        option :door_time, optional: true # The time admission will commence.
        ...
        option :event_status, optional: true # An eventStatus of an event represents its status; particularly useful when an event is cancelled or rescheduled.
        ...
        option :organizer, optional: true # An organizer of an Event.
        option :performers, optional: true # The main performer or performers of the event&#x2014;for example, a presenter, musician, or actor. Superseded by `performer`.
        option :previous_start_date, optional: true # Used in conjunction with eventStatus for rescheduled or cancelled events. This property contains the previously scheduled start date. For rescheduled events, the startDate property should be used for the newly scheduled start date. In the (rare) case of an event that has been postponed and rescheduled multiple times, this field may be repeated.
        option :remaining_attendee_capacity, optional: true # The number of attendee places for an event that remain unallocated.
        ...
        option :sub_events, optional: true # Events that are a part of this event. For example, a conference event includes many presentations, each subEvents of the conference. Superseded by `sub_event`.
        ...
        option :work_performed, optional: true # A work performed in some event, for example a play performed in a TheaterEvent.
        ...
        option :attendee, optional: true # A person or organization attending the event. Supersedes `attendees`.
        ...
        option :performer, optional: true # A performer at the event&#x2014;for example, a presenter, musician, musical group or actor. Supersedes `performers`.
        option :recorded_in, optional: true # The CreativeWork that captured all or part of this Event. Inverse-property: `recorded_at`.
        ...
        option :super_event, optional: true # An event that this event is a part of. For example, a collection of individual music performances might each have a music festival as their superEvent. Inverse-property: `sub_event`.
        option :about, optional: true # The subject matter of the content. Inverse-property: `subject_of`.
        option :sub_event, optional: true # An Event that is part of this event. For example, a conference event includes many presentations, each of which is a subEvent of the conference. Supersedes `sub_events`. Inverse-property: `super_event`.
        option :work_featured, optional: true # A work featured in some event, e.g. exhibited in an ExhibitionEvent.        Specific subproperties are available for workPerformed (e.g. a play), or a workPresented (a Movie at a ScreeningEvent).
