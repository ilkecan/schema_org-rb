  ...
  module Mixins
    module Offer
      ...
      included do
        ...
        option :add_on, optional: true # An additional offer that can only be obtained in combination with the first base offer (e.g. supplements and extensions that are available for a surcharge).
        ...
        option :price_valid_until, optional: true # The date after which the price is no longer available.
        option :reviews, optional: true # Review of the item. Superseded by `review`.
        option :shipping_details, optional: true # Indicates information about the shipping policies and options associated with an [[Offer]].
        ...
        option :offered_by, optional: true # A pointer to the organization or person making the offer. Inverse-property: `makes_offer`.
